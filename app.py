...
if analyze_btn:
    if not case_text.strip():
        ...
        with col_res2:
            st.markdown("""
                <div class="metric-card">
                    <h3>📝 مسودة الخطاب الرسمي المعتمد</h3>
                    <hr style="border-color: #334155;">
                    <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7;">
                    <b>سعادة جهة الاختصاص المحترمين،</b><br>
                    السلام عليكم ورحمة الله وبركاته،،<br><br>
                    أرفع إليكم خطابي هذا وأنا أملي كبير في تفهمكم الإنساني والنظامي لظروفي. فكما تعلمون، التزاماتي المالية الشهرية استنزفت مجمل دخلي بالكامل، ووجدت نفسي فجأة أمام عجز مالي طارئ يتمثل في مخالفة مرورية لا أستطيع سدادها دفعة واحدة دون أن يؤثر ذلك بشكل مباشر على أبسط متطلبات معيشيتي الأساسية.<br><br>
                    لذا، آمل من كرمكم التكرم بالنظر في حالتي بعين العطف والموافقة على <b>تقسيط هذا المبلغ أو تأجيل سداده</b> بما يتناسب مع قدرتي المالية الحالية، لكي أتمكن من الالتزام بسداده دون تعثر.<br><br>
                    <b>شاكر ومقدر حسن تعاونكم، ولكم جزيل الشكر والتقدير.</b>
                    </p>
                </div>
            """, unsafe_allow_html=True)
